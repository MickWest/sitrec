...
export class CNodeCurveEditorView extends CNodeViewCanvas2D {
  ...
  recalculate() {
    ...
    if (this.in.compare && this.in.compare.frames > 0)
      this.editor.compareNode.push(this.in.compare);
    if (this.in.compare1 && this.in.compare1.frames > 0)
      this.editor.compareNode.push(this.in.compare1);
    if (this.in.compare2 && this.in.compare2.frames > 0)
      this.editor.compareNode.push(this.in.compare2);
    if (this.in.compare3 && this.in.compare3.frames > 0)
      this.editor.compareNode.push(this.in.compare3);
    if (this.in.compare4 && this.in.compare4.frames > 0)
      this.editor.compareNode.push(this.in.compare4);
    if (this.in.compare5 && this.in.compare5.frames > 0)
      this.editor.compareNode.push(this.in.compare5);
    if (this.in.compare6 && this.in.compare6.frames > 0)
      this.editor.compareNode.push(this.in.compare6);
    if (this.in.compare7 && this.in.compare7.frames > 0)
      this.editor.compareNode.push(this.in.compare7);
    if (this.in.compare8 && this.in.compare8.frames > 0)
      this.editor.compareNode.push(this.in.compare8);
    if (this.in.compare9 && this.in.compare9.frames > 0)
      this.editor.compareNode.push(this.in.compare9);
...
export class CNodeCurveEditor extends CNode {
  constructor(v) {
    ...
    if (v.editorConfig.maxX === 'Sit.frames') v.editorConfig.maxX = Sit.frames;
