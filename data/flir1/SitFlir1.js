...
export const SitFlir1 = {
  ...
  terrain: { lat: 31.605, lon: -117.87, zoom: 7, nTiles: 6 },
  ...
  videoFile:
    '../sitrec-videos/public/f4-aspect-corrected-242x242-was-242x216.mp4',
  ...
  azEditor: {
    ...
    editorConfig: {
      ...
      yStep: 5,
      points: [
        0, 4.012, 352.26, 4.779, 360.596, 3.486, 360.596, 2.354, 999.406, 1.259,
        999.406, 0.138, 1833.796, -4.44, 1833.796, -5.561, 2288, -8.673, 2189,
        -8.673,
      ],
    },
  ...
  azStepsSeries: {
    ...
    graph: 'azEditor',
    color: '#008080',
    source: { id: 'roundAZ', kind: 'Math', math: 'round($azSources)' },
  },

  // jetLat: 31.205,
  // jetLon:-117.870,
  jetLat: { kind: 'Constant', value: 31.205 },
  jetLon: { kind: 'Constant', value: -117.87 },
  jetAltitude: {
    kind: 'inputFeet',
    value: 20000,
    desc: 'Altitude',
