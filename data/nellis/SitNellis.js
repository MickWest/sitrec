...
export const SitNellis = {
  ...
  videoFile:
    '../sitrec-videos/public/BEST QUALITY Nellis Test Range UFO Video - with frame numbers - LOW - S-30.mp4',
  ...
  mainCamera: {
    ...
    // view of path
    startCameraPositionLLA: [37.56931, -116.238502, 6397.351959],
    startCameraTargetLLA: [37.56696, -116.249286, 6241.443987],
  ...
  cameraTrack: { LLA: [37.521, -116.399833, 5100] },
  ...
  lookView: { left: 0.7, top: 0.3333, width: -1.6666, height: 0.3333 },
  videoView: { left: 0.7, top: 0.6666, width: -1.6666, height: 0.3333 },

  //  azRawData:  {kind: "arrayFromKeyframes", file: "FileAz", degrees: true, stepped: true},
  azData: {
    kind: 'arrayFromKeyframes',
    file: 'FileAz',
    degrees: true,
    exportable: true,
    frameOffset: -5077,
  ...
  startConstantDistance: {
    kind: 'GUIValue',
    value: 300,
    start: 0,
    end: 20000,
    step: 1,
    desc: 'Tgt Start Dist (Meters)',
  },

  LOSTraverseConstantDistance: {
    kind: 'LOSTraverse',
    LOS: 'JetLOS',
    startDist: 'startConstantDistance',
  },
