...
export const Sit29Palms = {
  ...
  threadURl:
    'https://www.metabunk.org/threads/twentynine-palms-camp-wilson-triangle-uap-flares.12967/page-3#post-293744',
  ...
  terrain: { lat: 34.366222, lon: -115.9758, zoom: 12, nTiles: 8 },
  ...
  cameraTrack: { LLA: [34.399060162, -115.85825745, 1380] },
  ...
  addTracks: {
    tracks: ['TargetTrack1', 'TargetTrack2', 'TargetTrack3'],
    sphereMask: 'WORLD',
    sphereColor: [1, 1, 0],
  },
